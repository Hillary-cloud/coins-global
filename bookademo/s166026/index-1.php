...
<div class="siteMiddleContainer">
  <div class="siteMiddleInner">
    ...
    <div class="landBanner" style="height:px">
      <img src="storage/images-processed/w-2000_h-auto_m-fit_s-any__book%20a%20demo%20UK%20construction%20%20%20logos%20NEW.png">
      <div class="landBannerText" style="
              ">
        <h1 style="color:#fcfcfc; font-size:70px;"><b></b>C<b></b>h<b></b>o<b></b>o<b></b>s<b></b>e<b></b> <b></b>C<b></b>O<b></b>I<b></b>N<b></b>S<b></b>.<b></b></h1>
        <h2></h2>
      </div>
    </div>
    ...
    <div class="mainContWrap">
      <div class="mainLeft">
        <div class="leftTop">
          <h2>COINS construction software is trusted by over 100,000 construction professionals across the world.</h2>
          <p>Experience cloud solutions designed for all construction sectors - from homebuilding, service managment and civil engineering companies to general contractors, specialist contractors and MEP contractors. COINS are the construction industry software experts.</p>
          <p>COINS partnership approach, best practice consulting and 'tried-and-tested' software solutions will transform the way you work.</p>
          <p>&nbsp;</p>
        </div>
      ...
      <div class="mainRight">
        ...
        <div class="rightBottom">
          <h2>Discover more about COINS ERP+</h2>
          <div class="formWrap">
            <div id="noThmb">
              ...
              <div id="ProgramName" style="display:none">FY23-P12-SCS-WEB-BOF-Demo-bookademo-CONS-NB-COINS-UK</div>
              <script>
                ...
                MktoForms2.whenReady(function(form) {
                  ...
                  form.addHiddenFields({
                    "programName": "FY23-P12-SCS-WEB-BOF-Demo-bookademo-CONS-NB-COINS-UK"
                  });

                  form.onSuccess(function(vals, tyURL) {
                    GetDetails("FY23-P12-SCS-WEB-BOF-Demo-bookademo-CONS-NB-COINS-UK");
